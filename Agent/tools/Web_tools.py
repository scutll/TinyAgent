...
from Agent.prompts.tools_prompt import fetch_webpage_prompt, fetch_webpage_with_selector_prompt


class fetch_webpage(Tool_):
    def __init__(self):
        super().__init__(fetch_webpage_prompt)
...
class fetch_webpage_with_selector(Tool_):
    def __init__(self):
        super().__init__(fetch_webpage_with_selector_prompt)
        
    def __call__(self, url: str, selector: str = "body"):
        '''
