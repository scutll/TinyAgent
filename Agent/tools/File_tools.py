...
class search_replace(Tool_):
    def __init__(self):
        super().__init__(search_replace_prompt)
        
    def __call__(self, path:str, match: str, replace: str):
...
class create_file(Tool_):
    def __init__(self):
        super().__init__(create_file_prompt)
        
        
    def __call__(self, path:str, file_name:str, content: str):
        '''
